...
description: Turns a Jira ticket's acceptance criteria into structured, reviewable Gherkin
test scenarios. Use this skill whenever the user references a Jira ticket (DS-1, DS-2, etc.) and asks for test cases, test plan, scenarios, or wants to plan testing for a ticket - even if they don't say the word "Gherkin".
---
...
2. Generate test scenarios as a Gherkin '.feature' filex
